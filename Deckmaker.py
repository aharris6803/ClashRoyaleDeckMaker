...
def builddeck():
    ...
    if deck == "['Hog Rider', 'Cannon', 'Musketeer', 'The Log', 'Skeletons', 'Fireball', 'Ice Golem', 'Ice Spirit']":
        deckdata = "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
...
print("Thanks for making a deck!")
